# Generated by Powerlevel10k configuration wizard on 2020-02-10 at 13:37 EST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 36878.
# Wizard options: powerline, classic, darkest, time, vertical separators, blurred heads,
# blurred tails, 2 lines, disconnected, full frame, compact, concise, transient_prompt,
